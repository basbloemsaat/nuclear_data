...
From data_sources/NUBASE2020.pdf extract Table I, from page 21 to 181 to a csv file. Implement `extract_table_from_pdf` in extract_nubase2020_table1.py. Store the resulting csv in data_sources/tmp.

Treat each page as a separate table and concatenate them into a single csv file.
